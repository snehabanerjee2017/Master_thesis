...
elif config["results"]["classifier"] in ['kmeans']:
        clf, pred, num_clusters = get_clusters(data = red_emb_all_points, classifier=config["results"]["classifier"],n_clusters=config['results']['n_clusters'],batch_size=config['results']['chunk_size'])
